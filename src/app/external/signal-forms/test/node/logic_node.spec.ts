...
describe('LogicNodeBuilder', () => {
  ...
  it('should build child logic', () => {
    ...
    builder
      .getChild('a')
      .addSyncErrorRule(() => [customError({ kind: 'root-err' })]);

    const logicNode = builder.build();
    expect(
      logicNode.getChild('a').logic.syncErrors.compute(fakeFieldContext)
    ).toEqual([customError({ kind: 'root-err' })]);
  });
  ...
  it('should build merged child logic', () => {
    ...
    builder2
      .getChild('a')
      .addSyncErrorRule(() => [customError({ kind: 'err-2' })]);
    builder.mergeIn(builder2);
  ...
  it('should combine predicates', () => {
    ...
    builder2
      .getChild('a')
      .mergeIn(builder3, { fn: () => pred2(), path: undefined! });
    builder.mergeIn(builder2, { fn: () => pred(), path: undefined! });
  ...
  it('should propagate predicates through deep application', () => {
    ...
    builder3
      .getChild('b')
      .mergeIn(builder4, { fn: () => pred3(), path: undefined! });
    builder2
      .getChild('a')
      .mergeIn(builder3, { fn: () => pred2(), path: undefined! });
    builder.mergeIn(builder2, { fn: () => pred(), path: undefined! });
  ...
  it('should preserve child ordering across merges', () => {
    ...
    builder
      .getChild('a')
      .addSyncErrorRule(() => [customError({ kind: 'err-3' })]);
  ...
  it('should support circular logic structures', () => {
    ...
    expect(
      logicNode.getChild('next').logic.syncErrors.compute(fakeFieldContext)
    ).toEqual([customError({ kind: 'err-1' })]);
    expect(
      logicNode
        .getChild('next')
  ...
  it('should support circular logic structures with predicate', () => {
    ...
    builder
      .getChild('next')
      .mergeIn(builder, { fn: () => pred(), path: undefined! });
