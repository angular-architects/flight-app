 ...
 */
export function listProperty<TItem>(): AggregateProperty<
  TItem[],
  TItem | undefined
> {
 ...
 */
export function minProperty(): AggregateProperty<
  number | undefined,
  number | undefined
> {
 ...
 */
export function maxProperty(): AggregateProperty<
  number | undefined,
  number | undefined
> {
  return reducedProperty<number | undefined, number | undefined>(
 ...
 */
export const MIN_LENGTH: AggregateProperty<
  number | undefined,
  number | undefined
> = maxProperty();
 ...
 */
export const MAX_LENGTH: AggregateProperty<
  number | undefined,
  number | undefined
> = minProperty();
