...
export class MaxValidationError extends _NgValidationError {
  ...
  constructor(readonly max: number, options?: ValidationErrorOptions) {
    super(options);
  }
}
...
export class MinLengthValidationError extends _NgValidationError {
  ...
  constructor(readonly minLength: number, options?: ValidationErrorOptions) {
    super(options);
  }
}
...
export class MaxLengthValidationError extends _NgValidationError {
  ...
  constructor(readonly maxLength: number, options?: ValidationErrorOptions) {
    super(options);
  }
}
...
export class PatternValidationError extends _NgValidationError {
  ...
  constructor(readonly pattern: RegExp, options?: ValidationErrorOptions) {
    super(options);
  }
}
