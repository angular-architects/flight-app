...
export type FieldValidationResult<E extends ValidationError = ValidationError> =
  ValidationSuccess | OneOrMany<WithoutField<E>>;
...
export type Subfields<TValue> = {
  readonly [K in keyof TValue as TValue[K] extends Function
    ? never
    : K]: MaybeField<TValue[K], string>;
};
 ...
 * @template TKey The type of the property key which this field resides under in its parent.
 */
export type MaybeField<
  TValue,
  TKey extends string | number = string | number
> = (TValue & undefined) | Field<Exclude<TValue, undefined>, TKey>;
...
> = (TValue & undefined) | FieldPath<Exclude<TValue, undefined>, TPathKind>;
 ...
 * @template TPathKind The kind of path this schema function can be bound to.
 */
export type SchemaOrSchemaFn<
  TValue,
  TPathKind extends PathKind = PathKind.Root
> = Schema<TValue> | SchemaFn<TValue, TPathKind>;
...
export type FieldValidator<
  TValue,
  TPathKind extends PathKind = PathKind.Root
> = LogicFn<TValue, FieldValidationResult, TPathKind>;
...
export type TreeValidator<
  TValue,
  TPathKind extends PathKind = PathKind.Root
> = LogicFn<TValue, TreeValidationResult, TPathKind>;
...
export type Validator<
  TValue,
  TPathKind extends PathKind = PathKind.Root
> = LogicFn<TValue, ValidationResult, TPathKind>;
