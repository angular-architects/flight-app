...
export class FieldNode implements FieldState<unknown> {
  ...
  constructor(options: FieldNodeOptions) {
    ...
    this.validationState = this.fieldAdapter.createValidationState(
      this,
      options
    );
  ...
  property<M>(
    prop: Property<M> | AggregateProperty<M, any>
  ): Signal<M> | M | undefined {
    return this.propertyState.get(prop);
  }
  hasProperty(
    prop: Property<unknown> | AggregateProperty<unknown, any>
  ): boolean {
