...
function createRootTView(rootSelectorOrNode, componentDef, componentBindings, directives) {
    const tAttributes = rootSelectorOrNode ? ["ng-version", "21.0.0-next.5"] :
...
var PlatformRef = class _PlatformRef {
    ...
    bootstrapModuleFactory(moduleFactory, options) {
        ...
        const allAppProviders = [provideZonelessChangeDetectionInternal(), ...defaultZoneCdProviders, ...(_additionalApplicationProviders ?? []), errorHandlerEnvironmentInitializer, ...(ngDevMode ? [validAppIdInitializer] : [])];
