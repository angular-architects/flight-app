...
import { ActionsSubject as ActionsSubject2, UPDATE, INIT, INITIAL_STATE, StateObservable, ReducerManagerDispatcher } from "@ngrx/store";
...
var _DevtoolsDispatcher = class _DevtoolsDispatcher extends ActionsSubject2 {
};
_DevtoolsDispatcher.ɵfac = /* @__PURE__ */ (() => {
    ...
    return function DevtoolsDispatcher_Factory(__ngFactoryType__) {
        return (ɵDevtoolsDispatcher_BaseFactory || (ɵDevtoolsDispatcher_BaseFactory = i0.ɵɵgetInheritedFactory(_DevtoolsDispatcher)))(__ngFactoryType__ || _DevtoolsDispatcher);
    };
})();
_DevtoolsDispatcher.ɵprov = /* @__PURE__ */ i0.ɵɵdefineInjectable({
...
_DevtoolsExtension.ɵfac = function DevtoolsExtension_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _DevtoolsExtension)(i0.ɵɵinject(REDUX_DEVTOOLS_EXTENSION), i0.ɵɵinject(STORE_DEVTOOLS_CONFIG), i0.ɵɵinject(DevtoolsDispatcher));
};
_DevtoolsExtension.ɵprov = /* @__PURE__ */ i0.ɵɵdefineInjectable({
...
_StoreDevtools.ɵfac = function StoreDevtools_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _StoreDevtools)(i0.ɵɵinject(DevtoolsDispatcher), i0.ɵɵinject(i2.ActionsSubject), i0.ɵɵinject(i2.ReducerObservable), i0.ɵɵinject(DevtoolsExtension), i0.ɵɵinject(i2.ScannedActionsSubject), i0.ɵɵinject(i0.ErrorHandler), i0.ɵɵinject(INITIAL_STATE), i0.ɵɵinject(STORE_DEVTOOLS_CONFIG));
};
_StoreDevtools.ɵprov = /* @__PURE__ */ i0.ɵɵdefineInjectable({
...
_StoreDevtoolsModule.ɵmod = /* @__PURE__ */ i0.ɵɵdefineNgModule({
    type: _StoreDevtoolsModule
});
_StoreDevtoolsModule.ɵinj = /* @__PURE__ */ i0.ɵɵdefineInjector({});
