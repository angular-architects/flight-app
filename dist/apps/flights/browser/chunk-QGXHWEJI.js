...
import { InjectionToken, inject, DOCUMENT as DOCUMENT2, ElementRef, ErrorHandler as ErrorHandler2, HostAttributeToken, booleanAttribute, Component, ViewEncapsulation, ChangeDetectionStrategy, Input, NgModule } from "@angular/core";
...
var MatIcon = class _MatIcon {
    ...
    _errorHandler = inject(ErrorHandler2);
    _defaultColor;
    /**
...
export { getMatIconNameNotFoundError, getMatIconNoHttpProviderError, getMatIconFailedToSanitizeUrlError, getMatIconFailedToSanitizeLiteralError, MatIconRegistry, MAT_ICON_DEFAULT_OPTIONS, MAT_ICON_LOCATION, MatIcon, MatIconModule };
